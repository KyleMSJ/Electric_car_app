package br.com.dio.electriccarapp.data.local

import android.content.ContentValues
import android.content.Context
import android.provider.BaseColumns
import android.util.Log
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_BATERIA
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_CAR_ID
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_POTENCIA
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_PRECO
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_RECARGA
import br.com.dio.electriccarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_URL_PHOTO
...
class CarRepository(private val context: Context) {
    ...
    fun findCarById(id: Int): Carro {
        ...
        val filter = "$COLUMN_NAME_CAR_ID = ?" // A interrogação é o que será informado depois
